...
plotdir = '../../plots/'
pgfdir = '../../report/pgf/'
files = ['maxError.txt', 'grid.txt', 'infNorm.txt', 'u_est.txt', 'u_ex.txt']
data = {}
print('hello')
fs = 15
...
surf2 = ax.plot_surface(X, Y, U_ex, cmap=cm.coolwarm, linewidth=0, antialiased=False)

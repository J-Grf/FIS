...
For the investigation of different number of coarse grid cycles $\gamma = 1...10$, the number of pre- and post smoothing iterations was set constant $\nu_1 = \nu_2 = 1$. Different $\gamma$ were analysed for a coarse and fine mesh, similar to the previous section. Figure \ref{fig::GAMMA} displays the Runtime for different $\gamma$ in the range $1...3$, following the theoretical trend for the workload $W_k$ that was discussed in the lecture
\begin{equation}
	...
	\begin{subfigure}[h!]{.49\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				coordinates{ (1, 0.000313459) (2, 0.000723542) (3, 0.001591)};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{subfigure}[h!]{.49\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				coordinates{ (1, 0.00472279) (2, 0.00779279) (3, 0.0351571)};
			\end{axis}
		\end{tikzpicture}
